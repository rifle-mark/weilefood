 ...
 *
 */
#define kPartnerID kAlipayPartnerID


/**
 *  seller:支付宝收款账号,手机号码或邮箱格式。
 */
#define kSellerAccount kAlipaySellerAccount

/**
 *  支付宝服务器主动通知商户 网站里指定的页面 http 路径。
 */
#define kNotifyURL kAlipayNotifyURL


/**
 *  appSckeme:应用注册scheme,在Info.plist定义URLtypes，处理支付宝回调
 */
#define kAppScheme kAlipayAppScheme


/**
 *  private_key:商户方的私钥,pkcs8 格式。
 */
#define kPrivateKey kAlipayPrivateKey
