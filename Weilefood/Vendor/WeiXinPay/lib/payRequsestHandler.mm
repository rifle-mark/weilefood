...
- (void) setPayNotifyUrl:(NSString *)url
{
    notifyUrl = [NSString stringWithString:url];
}
//获取debug信息
...
// 负责人：李启波（marcyli）
//============================================================
- (NSMutableDictionary *)sendPayWithOrderNum:(NSString *)orderNum name:(NSString *)name price:(NSString *)price{
    ...
    [packageParams setObject: [self whatismyipdotcom]    forKey:@"spbill_create_ip"];//发器支付的机器ip
